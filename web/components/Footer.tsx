    ...
    <footer className="mt-24 border-t border-zinc-800 py-12">
      <div className="mx-auto max-w-6xl px-6 grid grid-cols-2 md:grid-cols-4 gap-8 text-sm">
        <div className="col-span-2">
          <p className="text-zinc-100 font-medium mb-2">Docgen</p>
          <p className="text-zinc-500 max-w-xs leading-relaxed">
            Document generation as an API — templates, versioning, async
            renders, signed downloads. A portfolio build by{" "}
            <Link
              href="https://philiprehberger.com"
              className="text-zinc-300 hover:text-amber-300 underline-offset-4 hover:underline"
            >
              Philip Rehberger
            </Link>
        ...
        <div>
          ...
          <ul className="space-y-2 text-zinc-500">
            <li><FooterLink href="/concepts">Concepts</FooterLink></li>
        ...
        <div>
          ...
          <ul className="space-y-2 text-zinc-500">
            ...
            <li>
              <FooterLink href="https://github.com/philiprehberger/docgen">
                GitHub
              </FooterLink>
            </li>
            <li>
              <FooterLink href="https://philiprehberger.com">Author</FooterLink>
            </li>
          </ul>
        </div>
      </div>
