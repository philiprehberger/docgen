...
const SECTIONS = [
  {
    title: "Concepts",
    items: [
      { href: "/concepts/templating", label: "Twig templating" },
      { href: "/concepts/fields", label: "Merge-field discovery" },
      { href: "/concepts/versioning", label: "Frozen versions" },
      { href: "/concepts/async", label: "Async job lifecycle" },
      { href: "/concepts/signed-urls", label: "Signed downloads" },
      { href: "/concepts/docx-fidelity", label: "DOCX fidelity" },
    ],
  },
  {
    title: "Reference",
    items: [
      ...
      { href: "/templates", label: "Reference templates" },
